...
type TCLIService interface {
  ...
  // Parameters:
  //  - Req
  GetQueryId(req *TGetQueryIdReq) (r *TGetQueryIdResp, err error)
  // Parameters:
  //  - Req
  SetClientInfo(req *TSetClientInfoReq) (r *TSetClientInfoResp, err error)
}
...
// Parameters:
//  - Req
func (p *TCLIServiceClient) GetQueryId(req *TGetQueryIdReq) (r *TGetQueryIdResp, err error) {
  if err = p.sendGetQueryId(req); err != nil { return }
  return p.recvGetQueryId()
}

func (p *TCLIServiceClient) sendGetQueryId(req *TGetQueryIdReq)(err error) {
  oprot := p.OutputProtocol
  if oprot == nil {
    oprot = p.ProtocolFactory.GetProtocol(p.Transport)
    p.OutputProtocol = oprot
  ...
  p.SeqId++
  if err = oprot.WriteMessageBegin("GetQueryId", thrift.CALL, p.SeqId); err != nil {
      return
  }
...
func (p *TCLIServiceClient) recvGetQueryId() (value *TGetQueryIdResp, err error) {
  iprot := p.InputProtocol
  if iprot == nil {
    iprot = p.ProtocolFactory.GetProtocol(p.Transport)
    p.InputProtocol = iprot
  ...
  if method != "GetQueryId" {
    err = thrift.NewTApplicationException(thrift.WRONG_METHOD_NAME, "GetQueryId failed: wrong method name")
    return
  }
  if p.SeqId != seqId {
    err = thrift.NewTApplicationException(thrift.BAD_SEQUENCE_ID, "GetQueryId failed: out of sequence response")
    return
  }
  if mTypeId == thrift.EXCEPTION {
  ...
  if mTypeId != thrift.REPLY {
    err = thrift.NewTApplicationException(thrift.INVALID_MESSAGE_TYPE_EXCEPTION, "GetQueryId failed: invalid message type")
    return
  }
...
// Parameters:
//  - Req
func (p *TCLIServiceClient) SetClientInfo(req *TSetClientInfoReq) (r *TSetClientInfoResp, err error) {
  if err = p.sendSetClientInfo(req); err != nil { return }
  return p.recvSetClientInfo()
}

func (p *TCLIServiceClient) sendSetClientInfo(req *TSetClientInfoReq)(err error) {
  oprot := p.OutputProtocol
  if oprot == nil {
    oprot = p.ProtocolFactory.GetProtocol(p.Transport)
    p.OutputProtocol = oprot
  ...
  p.SeqId++
  if err = oprot.WriteMessageBegin("SetClientInfo", thrift.CALL, p.SeqId); err != nil {
      return
  }
...
func (p *TCLIServiceClient) recvSetClientInfo() (value *TSetClientInfoResp, err error) {
  iprot := p.InputProtocol
  if iprot == nil {
    iprot = p.ProtocolFactory.GetProtocol(p.Transport)
    p.InputProtocol = iprot
  ...
  if method != "SetClientInfo" {
    err = thrift.NewTApplicationException(thrift.WRONG_METHOD_NAME, "SetClientInfo failed: wrong method name")
    return
  }
  if p.SeqId != seqId {
    err = thrift.NewTApplicationException(thrift.BAD_SEQUENCE_ID, "SetClientInfo failed: out of sequence response")
    return
  }
  if mTypeId == thrift.EXCEPTION {
  ...
  if mTypeId != thrift.REPLY {
    err = thrift.NewTApplicationException(thrift.INVALID_MESSAGE_TYPE_EXCEPTION, "SetClientInfo failed: invalid message type")
    return
  }
...
func (p *tCLIServiceProcessorGetQueryId) Process(seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
  args := TCLIServiceGetQueryIdArgs{}
  if err = args.Read(iprot); err != nil {
    iprot.ReadMessageEnd()
    x := thrift.NewTApplicationException(thrift.PROTOCOL_ERROR, err.Error())
...
var retval *TGetQueryIdResp
  var err2 error
  if retval, err2 = p.handler.GetQueryId(args.Req); err2 != nil {
...
func (p *tCLIServiceProcessorSetClientInfo) Process(seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
  args := TCLIServiceSetClientInfoArgs{}
  if err = args.Read(iprot); err != nil {
    iprot.ReadMessageEnd()
    x := thrift.NewTApplicationException(thrift.PROTOCOL_ERROR, err.Error())
...
var retval *TSetClientInfoResp
  var err2 error
  if retval, err2 = p.handler.SetClientInfo(args.Req); err2 != nil {
